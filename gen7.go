...
var (
	Gen7BaseStats = [][]Gen7Base{
		...
		{{19, "Rattata (Alolan Rattata)", 30, 56, 35, 72, 25, 35}},
		{{20, "Raticate", 55, 81, 60, 97, 50, 70}},
		{{20, "Raticate (Alolan Raticate)", 75, 71, 70, 77, 40, 80}},
		{{21, "Spearow", 40, 60, 30, 70, 31, 31}},
		{{22, "Fearow", 65, 90, 65, 100, 61, 61}},
		{{23, "Ekans", 35, 60, 44, 55, 40, 54}},
		{{24, "Arbok", 60, 95, 69, 80, 65, 79}},
		{{25, "Pikachu", 35, 55, 40, 90, 50, 50}},
		{{26, "Raichu", 60, 90, 55, 110, 90, 80}},
		{{26, "Raichu (Alolan Raichu)", 60, 85, 50, 110, 95, 85}},
		{{27, "Sandshrew", 50, 75, 85, 40, 20, 30}},
		{{27, "Sandshrew (Alolan Sandshrew)", 50, 75, 90, 40, 10, 35}},
		{{28, "Sandslash", 75, 100, 110, 65, 45, 55}},
		{{28, "Sandslash (Alolan Sandslash)", 75, 100, 120, 65, 25, 65}},
		...
		{{37, "Vulpix (Alolan Vulpix)", 38, 41, 40, 65, 50, 65}},
		{{38, "Ninetales", 73, 76, 75, 100, 81, 100}},
		{{38, "Ninetales (Alolan Ninetales)", 73, 67, 75, 109, 81, 100}},
		...
		{{50, "Diglett (Alolan Diglett)", 10, 55, 30, 90, 35, 45}},
		{{51, "Dugtrio", 35, 100, 50, 120, 50, 70}},
		{{51, "Dugtrio (Alolan Dugtrio)", 35, 100, 60, 110, 50, 70}},
		{{52, "Meowth", 40, 45, 35, 90, 40, 40}},
		{{52, "Meowth (Alolan Meowth)", 40, 35, 35, 90, 50, 40}},
		{{53, "Persian", 65, 70, 60, 115, 65, 65}},
		{{53, "Persian (Alolan Persian)", 65, 60, 60, 115, 75, 65}},
		...
		{{65, "Alakazam (Mega Alakazam)", 55, 50, 65, 150, 175, 105}},
		...
		{{74, "Geodude (Alolan Geodude)", 40, 80, 100, 20, 30, 30}},
		{{75, "Graveler", 55, 95, 115, 35, 45, 45}},
		{{75, "Graveler (Alolan Graveler)", 55, 95, 115, 35, 45, 45}},
		{{76, "Golem", 80, 120, 130, 45, 55, 65}},
		{{76, "Golem (Alolan Golem)", 80, 120, 130, 45, 55, 65}},
		...
		{{83, "Farfetch&#x27;d", 52, 90, 55, 60, 58, 62}},
		{{84, "Doduo", 35, 85, 45, 75, 35, 35}},
		{{85, "Dodrio", 60, 110, 70, 110, 60, 60}},
		{{86, "Seel", 65, 45, 55, 45, 45, 70}},
		{{87, "Dewgong", 90, 70, 80, 70, 70, 95}},
		{{88, "Grimer", 80, 80, 50, 25, 40, 50}},
		{{88, "Grimer (Alolan Grimer)", 80, 80, 50, 25, 40, 50}},
		{{89, "Muk", 105, 105, 75, 50, 65, 100}},
		{{89, "Muk (Alolan Muk)", 105, 105, 75, 50, 65, 100}},
		...
		{{101, "Electrode", 60, 50, 70, 150, 80, 80}},
		{{102, "Exeggcute", 60, 40, 80, 40, 60, 45}},
		{{103, "Exeggutor", 95, 95, 85, 55, 125, 75}},
		{{103, "Exeggutor (Alolan Exeggutor)", 95, 105, 85, 45, 125, 75}},
		{{104, "Cubone", 50, 50, 95, 35, 40, 50}},
		{{105, "Marowak", 60, 80, 110, 45, 50, 80}},
		{{105, "Marowak (Alolan Marowak)", 60, 80, 110, 45, 50, 80}},
		...
		{{211, "Qwilfish", 65, 95, 85, 85, 55, 55}},
		...
		{{277, "Swellow", 60, 85, 60, 125, 75, 50}},
		{{278, "Wingull", 40, 30, 30, 85, 55, 30}},
		{{279, "Pelipper", 60, 50, 100, 65, 95, 70}},
		...
		{{284, "Masquerain", 70, 60, 62, 80, 100, 82}},
		...
		{{301, "Delcatty", 70, 65, 65, 90, 55, 55}},
		...
		{{313, "Volbeat", 65, 73, 75, 85, 47, 85}},
		{{314, "Illumise", 65, 47, 75, 85, 73, 85}},
		...
		{{337, "Lunatone", 90, 55, 65, 70, 95, 85}},
		{{338, "Solrock", 90, 95, 85, 70, 55, 65}},
		...
		{{358, "Chimecho", 75, 50, 80, 65, 95, 90}},
		...
		{{558, "Crustle", 70, 105, 125, 45, 65, 75}},
		...
		{{614, "Beartic", 95, 130, 80, 50, 70, 80}},
		{{615, "Cryogonal", 80, 50, 50, 105, 95, 135}},
		...
		{{658, "Greninja (Ash-Greninja)", 72, 145, 67, 132, 153, 71}},
		...
		{{718, "Zygarde (50% Forme)", 108, 100, 121, 95, 81, 95}},
		{{718, "Zygarde (10% Forme)", 54, 100, 71, 115, 61, 85}},
		{{718, "Zygarde (Complete Forme)", 216, 100, 121, 85, 91, 95}},
		...
		{{722, "Rowlet", 68, 55, 55, 42, 50, 50}},
		{{723, "Dartrix", 78, 75, 75, 52, 70, 70}},
		{{724, "Decidueye", 78, 107, 75, 70, 100, 100}},
		{{725, "Litten", 45, 65, 40, 70, 60, 40}},
		{{726, "Torracat", 65, 85, 50, 90, 80, 50}},
		{{727, "Incineroar", 95, 115, 90, 60, 80, 90}},
		{{728, "Popplio", 50, 54, 54, 40, 66, 56}},
		{{729, "Brionne", 60, 69, 69, 50, 91, 81}},
		{{730, "Primarina", 80, 74, 74, 60, 126, 116}},
		{{731, "Pikipek", 35, 75, 30, 65, 30, 30}},
		{{732, "Trumbeak", 55, 85, 50, 75, 40, 50}},
		{{733, "Toucannon", 80, 120, 75, 60, 75, 75}},
		{{734, "Yungoos", 48, 70, 30, 45, 30, 30}},
		{{735, "Gumshoos", 88, 110, 60, 45, 55, 60}},
		{{736, "Grubbin", 47, 62, 45, 46, 55, 45}},
		{{737, "Charjabug", 57, 82, 95, 36, 55, 75}},
		{{738, "Vikavolt", 77, 70, 90, 43, 145, 75}},
		{{739, "Crabrawler", 47, 82, 57, 63, 42, 47}},
		{{740, "Crabominable", 97, 132, 77, 43, 62, 67}},
		{{741, "Oricorio", 75, 70, 70, 93, 98, 70}},
		{{742, "Cutiefly", 40, 45, 40, 84, 55, 40}},
		{{743, "Ribombee", 60, 55, 60, 124, 95, 70}},
		{{744, "Rockruff", 45, 65, 40, 60, 30, 40}},
		{{745, "Lycanroc (Midday Form)", 75, 115, 65, 112, 55, 65}},
		{{745, "Lycanroc (Midnight Form)", 85, 115, 75, 82, 55, 75}},
		{{745, "Lycanroc (Dusk Form)", 75, 117, 65, 110, 55, 65}},
		{{746, "Wishiwashi (Solo Form)", 45, 20, 20, 40, 25, 25}},
		{{746, "Wishiwashi (School Form)", 45, 140, 130, 30, 140, 135}},
		{{747, "Mareanie", 50, 53, 62, 45, 43, 52}},
		{{748, "Toxapex", 50, 63, 152, 35, 53, 142}},
		{{749, "Mudbray", 70, 100, 70, 45, 45, 55}},
		{{750, "Mudsdale", 100, 125, 100, 35, 55, 85}},
		{{751, "Dewpider", 38, 40, 52, 27, 40, 72}},
		{{752, "Araquanid", 68, 70, 92, 42, 50, 132}},
		{{753, "Fomantis", 40, 55, 35, 35, 50, 35}},
		{{754, "Lurantis", 70, 105, 90, 45, 80, 90}},
		{{755, "Morelull", 40, 35, 55, 15, 65, 75}},
		{{756, "Shiinotic", 60, 45, 80, 30, 90, 100}},
		{{757, "Salandit", 48, 44, 40, 77, 71, 40}},
		{{758, "Salazzle", 68, 64, 60, 117, 111, 60}},
		{{759, "Stufful", 70, 75, 50, 50, 45, 50}},
		{{760, "Bewear", 120, 125, 80, 60, 55, 60}},
		{{761, "Bounsweet", 42, 30, 38, 32, 30, 38}},
		{{762, "Steenee", 52, 40, 48, 62, 40, 48}},
		{{763, "Tsareena", 72, 120, 98, 72, 50, 98}},
		{{764, "Comfey", 51, 52, 90, 100, 82, 110}},
		{{765, "Oranguru", 90, 60, 80, 60, 90, 110}},
		{{766, "Passimian", 100, 120, 90, 80, 40, 60}},
		{{767, "Wimpod", 25, 35, 40, 80, 20, 30}},
		{{768, "Golisopod", 75, 125, 140, 40, 60, 90}},
		{{769, "Sandygast", 55, 55, 80, 15, 70, 45}},
		{{770, "Palossand", 85, 75, 110, 35, 100, 75}},
		{{771, "Pyukumuku", 55, 60, 130, 5, 30, 130}},
		{{772, "Type: Null", 95, 95, 95, 59, 95, 95}},
		{{773, "Silvally", 95, 95, 95, 95, 95, 95}},
		{{774, "Minior (Meteor Form)", 60, 60, 100, 60, 60, 100}},
		{{774, "Minior (Core Form)", 60, 100, 60, 120, 100, 60}},
		{{775, "Komala", 65, 115, 65, 65, 75, 95}},
		{{776, "Turtonator", 60, 78, 135, 36, 91, 85}},
		{{777, "Togedemaru", 65, 98, 63, 96, 40, 73}},
		{{778, "Mimikyu", 55, 90, 80, 96, 50, 105}},
		{{779, "Bruxish", 68, 105, 70, 92, 70, 70}},
		{{780, "Drampa", 78, 60, 85, 36, 135, 91}},
		{{781, "Dhelmise", 70, 131, 100, 40, 86, 90}},
		{{782, "Jangmo-o", 45, 55, 65, 45, 45, 45}},
		{{783, "Hakamo-o", 55, 75, 90, 65, 65, 70}},
		{{784, "Kommo-o", 75, 110, 125, 85, 100, 105}},
		{{785, "Tapu Koko", 70, 115, 85, 130, 95, 75}},
		{{786, "Tapu Lele", 70, 85, 75, 95, 130, 115}},
		{{787, "Tapu Bulu", 70, 130, 115, 75, 85, 95}},
		{{788, "Tapu Fini", 70, 75, 115, 85, 95, 130}},
		{{789, "Cosmog", 43, 29, 31, 37, 29, 31}},
		{{790, "Cosmoem", 43, 29, 131, 37, 29, 131}},
		{{791, "Solgaleo", 137, 137, 107, 97, 113, 89}},
		{{792, "Lunala", 137, 113, 89, 97, 137, 107}},
		{{793, "Nihilego", 109, 53, 47, 103, 127, 131}},
		{{794, "Buzzwole", 107, 139, 139, 79, 53, 53}},
		{{795, "Pheromosa", 71, 137, 37, 151, 137, 37}},
		{{796, "Xurkitree", 83, 89, 71, 83, 173, 71}},
		{{797, "Celesteela", 97, 101, 103, 61, 107, 101}},
		{{798, "Kartana", 59, 181, 131, 109, 59, 31}},
		{{799, "Guzzlord", 223, 101, 53, 43, 97, 53}},
		{{800, "Necrozma", 97, 107, 101, 79, 127, 89}},
		{{800, "Necrozma (Dusk Mane)", 97, 157, 127, 77, 113, 109}},
		{{800, "Necrozma (Dawn Wings)", 97, 113, 109, 77, 157, 127}},
		{{800, "Necrozma (Ultra Necrozma)", 97, 167, 97, 129, 167, 97}},
		{{801, "Magearna", 80, 95, 115, 65, 130, 115}},
		{{802, "Marshadow", 90, 125, 80, 125, 90, 90}},
		{{803, "Poipole", 67, 73, 67, 73, 73, 67}},
		{{804, "Naganadel", 73, 73, 73, 121, 127, 73}},
		{{805, "Stakataka", 61, 131, 211, 13, 53, 101}},
		{{806, "Blacephalon", 53, 127, 53, 107, 151, 79}},
		{{807, "Zeraora", 88, 112, 75, 143, 102, 80}},
	}
)
